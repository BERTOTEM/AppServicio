...
public class CrearSoporteTecnico extends Command {


    private final SoporteTecnicoId soporteTecnicoId;
    private final HerramientaEspecializada herramientaEspecializada;

    public CrearSoporteTecnico(SoporteTecnicoId soporteTecnicoId, HerramientaEspecializada herramientaEspecializada) {
